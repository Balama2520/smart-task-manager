...
function drawTask(t) {
  ...
  return '<div class="task-item' + (t.done ? ' done' : '') + '" data-id="' + t.id + '">' +
    '<button class="cbox' + (t.done ? ' on' : '') + '" data-a="check">' + (t.done ? '✓' : '') + '</button>' +
    '<div class="tbody">' +
    '<span class="ttext">' + esc(t.text) + '</span>' +
    '<div class="tmeta">' +
    '<span class="ttag tag-' + t.category + '">' + t.category + '</span>' +
    '<span class="pdot p-' + t.priority + '" title="' + t.priority + '"></span>' +
    dueStr +
    '</div>' +
    '</div>' +
    '<div class="tactions">' +
    '<button class="tabtn" data-a="edit" title="Edit">✎</button>' +
    '<button class="tabtn del" data-a="del" title="Delete">✕</button>' +
    '</div>' +
    '</div>';
}
